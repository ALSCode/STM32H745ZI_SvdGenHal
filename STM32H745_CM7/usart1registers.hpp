...
struct USART1
{
  ...
  struct CR1 : public RegisterBase<0x40011000, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CR1Pack  = Register<0x40011000, 32, ReadWriteMode, USART1CR1Base, T...> ;

  struct USART1CR2Base {} ;

  struct CR2 : public RegisterBase<0x40011004, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CR2Pack  = Register<0x40011004, 32, ReadWriteMode, USART1CR2Base, T...> ;

  struct USART1CR3Base {} ;

  struct CR3 : public RegisterBase<0x40011008, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CR3Pack  = Register<0x40011008, 32, ReadWriteMode, USART1CR3Base, T...> ;

  struct USART1BRRBase {} ;

  struct BRR : public RegisterBase<0x4001100C, 32, ReadWriteMode>
  {
    using BRR_4_15 = USART1_BRR_BRR_4_15_Values<USART1::BRR, 4, 12, ReadWriteMode, USART1BRRBase> ;
    using BRR_0_3 = USART1_BRR_BRR_0_3_Values<USART1::BRR, 0, 4, ReadWriteMode, USART1BRRBase> ;
    using FieldValues = USART1_BRR_BRR_0_3_Values<USART1::BRR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using BRRPack  = Register<0x4001100C, 32, ReadWriteMode, USART1BRRBase, T...> ;

  struct USART1GTPRBase {} ;

  struct GTPR : public RegisterBase<0x40011010, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using GTPRPack  = Register<0x40011010, 32, ReadWriteMode, USART1GTPRBase, T...> ;

  struct USART1RTORBase {} ;

  struct RTOR : public RegisterBase<0x40011014, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using RTORPack  = Register<0x40011014, 32, ReadWriteMode, USART1RTORBase, T...> ;

  struct USART1RQRBase {} ;

  struct RQR : public RegisterBase<0x40011018, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using RQRPack  = Register<0x40011018, 32, WriteMode, USART1RQRBase, T...> ;

  struct USART1ISRBase {} ;

  struct ISR : public RegisterBase<0x4001101C, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using ISRPack  = Register<0x4001101C, 32, ReadMode, USART1ISRBase, T...> ;

  struct USART1ICRBase {} ;

  struct ICR : public RegisterBase<0x40011020, 32, WriteMode>
  {
    ...
    using TCBGTC = USART1_ICR_TCBGTC_Values<USART1::ICR, 7, 1, WriteMode, USART1ICRBase> ;
  ...
  template<typename... T> 
  using ICRPack  = Register<0x40011020, 32, WriteMode, USART1ICRBase, T...> ;

  struct USART1RDRBase {} ;

  struct RDR : public RegisterBase<0x40011024, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using RDRPack  = Register<0x40011024, 32, ReadMode, USART1RDRBase, T...> ;

  struct USART1TDRBase {} ;

  struct TDR : public RegisterBase<0x40011028, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using TDRPack  = Register<0x40011028, 32, ReadWriteMode, USART1TDRBase, T...> ;

  struct USART1PRESCBase {} ;

  struct PRESC : public RegisterBase<0x4001102C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using PRESCPack  = Register<0x4001102C, 32, ReadWriteMode, USART1PRESCBase, T...> ;
