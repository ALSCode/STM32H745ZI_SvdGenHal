...
struct USART2
{
  ...
  {
    using RXFFIE = USART2_CR1_RXFFIE_Values<USART2::CR1, 31, 1, ReadWriteMode, USART2CR1Base> ;
    using TXFEIE = USART2_CR1_TXFEIE_Values<USART2::CR1, 30, 1, ReadWriteMode, USART2CR1Base> ;
    using FIFOEN = USART2_CR1_FIFOEN_Values<USART2::CR1, 29, 1, ReadWriteMode, USART2CR1Base> ;
  ...
  struct CR2 : public RegisterBase<0x40004404, 32, ReadWriteMode>
  {
    ...
    using DIS_NSS = USART2_CR2_DIS_NSS_Values<USART2::CR2, 3, 1, ReadWriteMode, USART2CR2Base> ;
    using SLVEN = USART2_CR2_SLVEN_Values<USART2::CR2, 0, 1, ReadWriteMode, USART2CR2Base> ;
    using FieldValues = USART2_CR2_SLVEN_Values<USART2::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using TXFTCFG = USART2_CR3_TXFTCFG_Values<USART2::CR3, 29, 3, ReadWriteMode, USART2CR3Base> ;
    using RXFTIE = USART2_CR3_RXFTIE_Values<USART2::CR3, 28, 1, ReadWriteMode, USART2CR3Base> ;
    using RXFTCFG = USART2_CR3_RXFTCFG_Values<USART2::CR3, 25, 3, ReadWriteMode, USART2CR3Base> ;
    using TCBGTIE = USART2_CR3_TCBGTIE_Values<USART2::CR3, 24, 1, ReadWriteMode, USART2CR3Base> ;
    using TXFTIE = USART2_CR3_TXFTIE_Values<USART2::CR3, 23, 1, ReadWriteMode, USART2CR3Base> ;
  ...
  {
    using BRR_4_15 = USART2_BRR_BRR_4_15_Values<USART2::BRR, 4, 12, ReadWriteMode, USART2BRRBase> ;
    using BRR_0_3 = USART2_BRR_BRR_0_3_Values<USART2::BRR, 0, 4, ReadWriteMode, USART2BRRBase> ;
    using FieldValues = USART2_BRR_BRR_0_3_Values<USART2::BRR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using TXFT = USART2_ISR_TXFT_Values<USART2::ISR, 27, 1, ReadMode, USART2ISRBase> ;
    using RXFT = USART2_ISR_RXFT_Values<USART2::ISR, 26, 1, ReadMode, USART2ISRBase> ;
    using TCBGT = USART2_ISR_TCBGT_Values<USART2::ISR, 25, 1, ReadMode, USART2ISRBase> ;
    using RXFF = USART2_ISR_RXFF_Values<USART2::ISR, 24, 1, ReadMode, USART2ISRBase> ;
    using TXFE = USART2_ISR_TXFE_Values<USART2::ISR, 23, 1, ReadMode, USART2ISRBase> ;
    ...
    using UDR = USART2_ISR_UDR_Values<USART2::ISR, 13, 1, ReadMode, USART2ISRBase> ;
  ...
  struct ICR : public RegisterBase<0x40004420, 32, WriteMode>
  {
    ...
    using UDRCF = USART2_ICR_UDRCF_Values<USART2::ICR, 13, 1, WriteMode, USART2ICRBase> ;
    ...
    using TCBGTC = USART2_ICR_TCBGTC_Values<USART2::ICR, 7, 1, WriteMode, USART2ICRBase> ;
    using TCCF = USART2_ICR_TCCF_Values<USART2::ICR, 6, 1, WriteMode, USART2ICRBase> ;
    using TXFECF = USART2_ICR_TXFECF_Values<USART2::ICR, 5, 1, WriteMode, USART2ICRBase> ;
  ...
  struct USART2PRESCBase {} ;

  struct PRESC : public RegisterBase<0x4000442C, 32, ReadWriteMode>
  {
    using PRESCALER = USART2_PRESC_PRESCALER_Values<USART2::PRESC, 0, 4, ReadWriteMode, USART2PRESCBase> ;
    using FieldValues = USART2_PRESC_PRESCALER_Values<USART2::PRESC, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using PRESCPack  = Register<0x4000442C, 32, ReadWriteMode, USART2PRESCBase, T...> ;
