...
struct SAI1
{
  struct SAI1SAI_GCRBase {} ;

  struct SAI_GCR : public RegisterBase<0x40015800, 32, ReadWriteMode>
  {
    using SYNCOUT = SAI1_SAI_GCR_SYNCOUT_Values<SAI1::SAI_GCR, 4, 2, ReadWriteMode, SAI1SAI_GCRBase> ;
    using SYNCIN = SAI1_SAI_GCR_SYNCIN_Values<SAI1::SAI_GCR, 0, 2, ReadWriteMode, SAI1SAI_GCRBase> ;
    using FieldValues = SAI1_SAI_GCR_SYNCIN_Values<SAI1::SAI_GCR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SAI_GCRPack  = Register<0x40015800, 32, ReadWriteMode, SAI1SAI_GCRBase, T...> ;
  ...
  struct SAI_ACR1 : public RegisterBase<0x40015804, 32, ReadWriteMode>
  {
    ...
    using SAIXEN = SAI1_SAI_ACR1_SAIXEN_Values<SAI1::SAI_ACR1, 16, 1, ReadWriteMode, SAI1SAI_ACR1Base> ;
    using DMAEN = SAI1_SAI_ACR1_DMAEN_Values<SAI1::SAI_ACR1, 17, 1, ReadWriteMode, SAI1SAI_ACR1Base> ;
    using NOMCK = SAI1_SAI_ACR1_NOMCK_Values<SAI1::SAI_ACR1, 19, 1, ReadWriteMode, SAI1SAI_ACR1Base> ;
    using MCKDIV = SAI1_SAI_ACR1_MCKDIV_Values<SAI1::SAI_ACR1, 20, 4, ReadWriteMode, SAI1SAI_ACR1Base> ;
    using OSR = SAI1_SAI_ACR1_OSR_Values<SAI1::SAI_ACR1, 26, 1, ReadWriteMode, SAI1SAI_ACR1Base> ;
    using FieldValues = SAI1_SAI_ACR1_OSR_Values<SAI1::SAI_ACR1, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct SAI_ACR2 : public RegisterBase<0x40015808, 32, ReadWriteMode>
  {
    ...
    using FFLUSH = SAI1_SAI_ACR2_FFLUSH_Values<SAI1::SAI_ACR2, 3, 1, WriteMode, SAI1SAI_ACR2Base> ;
  ...
  struct SAI_ASR : public RegisterBase<0x40015818, 32, ReadMode>
  {
    ...
    using FLVL = SAI1_SAI_ASR_FLVL_Values<SAI1::SAI_ASR, 16, 3, ReadMode, SAI1SAI_ASRBase> ;
    using FieldValues = SAI1_SAI_ASR_FLVL_Values<SAI1::SAI_ASR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct SAI_ACLRFR : public RegisterBase<0x4001581C, 32, WriteMode>
  {
    using COVRUDR = SAI1_SAI_ACLRFR_COVRUDR_Values<SAI1::SAI_ACLRFR, 0, 1, WriteMode, SAI1SAI_ACLRFRBase> ;
    using CMUTEDET = SAI1_SAI_ACLRFR_CMUTEDET_Values<SAI1::SAI_ACLRFR, 1, 1, WriteMode, SAI1SAI_ACLRFRBase> ;
    using CWCKCFG = SAI1_SAI_ACLRFR_CWCKCFG_Values<SAI1::SAI_ACLRFR, 2, 1, WriteMode, SAI1SAI_ACLRFRBase> ;
    using CCNRDY = SAI1_SAI_ACLRFR_CCNRDY_Values<SAI1::SAI_ACLRFR, 4, 1, WriteMode, SAI1SAI_ACLRFRBase> ;
    using CAFSDET = SAI1_SAI_ACLRFR_CAFSDET_Values<SAI1::SAI_ACLRFR, 5, 1, WriteMode, SAI1SAI_ACLRFRBase> ;
    using CLFSDET = SAI1_SAI_ACLRFR_CLFSDET_Values<SAI1::SAI_ACLRFR, 6, 1, WriteMode, SAI1SAI_ACLRFRBase> ;
    using FieldValues = SAI1_SAI_ACLRFR_CLFSDET_Values<SAI1::SAI_ACLRFR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SAI_ACLRFRPack  = Register<0x4001581C, 32, WriteMode, SAI1SAI_ACLRFRBase, T...> ;
  ...
  struct SAI_BCR1 : public RegisterBase<0x40015824, 32, ReadWriteMode>
  {
    ...
    using SAIXEN = SAI1_SAI_BCR1_SAIXEN_Values<SAI1::SAI_BCR1, 16, 1, ReadWriteMode, SAI1SAI_BCR1Base> ;
    using DMAEN = SAI1_SAI_BCR1_DMAEN_Values<SAI1::SAI_BCR1, 17, 1, ReadWriteMode, SAI1SAI_BCR1Base> ;
    using NOMCK = SAI1_SAI_BCR1_NOMCK_Values<SAI1::SAI_BCR1, 19, 1, ReadWriteMode, SAI1SAI_BCR1Base> ;
    using MCKDIV = SAI1_SAI_BCR1_MCKDIV_Values<SAI1::SAI_BCR1, 20, 4, ReadWriteMode, SAI1SAI_BCR1Base> ;
    using OSR = SAI1_SAI_BCR1_OSR_Values<SAI1::SAI_BCR1, 26, 1, ReadWriteMode, SAI1SAI_BCR1Base> ;
    using FieldValues = SAI1_SAI_BCR1_OSR_Values<SAI1::SAI_BCR1, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct SAI_BCR2 : public RegisterBase<0x40015828, 32, ReadWriteMode>
  {
    ...
    using FFLUSH = SAI1_SAI_BCR2_FFLUSH_Values<SAI1::SAI_BCR2, 3, 1, WriteMode, SAI1SAI_BCR2Base> ;
  ...
  struct SAI_BSR : public RegisterBase<0x40015838, 32, ReadMode>
  {
    ...
    using FLVL = SAI1_SAI_BSR_FLVL_Values<SAI1::SAI_BSR, 16, 3, ReadMode, SAI1SAI_BSRBase> ;
    using FieldValues = SAI1_SAI_BSR_FLVL_Values<SAI1::SAI_BSR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct SAI_BCLRFR : public RegisterBase<0x4001583C, 32, WriteMode>
  {
    using COVRUDR = SAI1_SAI_BCLRFR_COVRUDR_Values<SAI1::SAI_BCLRFR, 0, 1, WriteMode, SAI1SAI_BCLRFRBase> ;
    using CMUTEDET = SAI1_SAI_BCLRFR_CMUTEDET_Values<SAI1::SAI_BCLRFR, 1, 1, WriteMode, SAI1SAI_BCLRFRBase> ;
    using CWCKCFG = SAI1_SAI_BCLRFR_CWCKCFG_Values<SAI1::SAI_BCLRFR, 2, 1, WriteMode, SAI1SAI_BCLRFRBase> ;
    using CCNRDY = SAI1_SAI_BCLRFR_CCNRDY_Values<SAI1::SAI_BCLRFR, 4, 1, WriteMode, SAI1SAI_BCLRFRBase> ;
    using CAFSDET = SAI1_SAI_BCLRFR_CAFSDET_Values<SAI1::SAI_BCLRFR, 5, 1, WriteMode, SAI1SAI_BCLRFRBase> ;
    using CLFSDET = SAI1_SAI_BCLRFR_CLFSDET_Values<SAI1::SAI_BCLRFR, 6, 1, WriteMode, SAI1SAI_BCLRFRBase> ;
    using FieldValues = SAI1_SAI_BCLRFR_CLFSDET_Values<SAI1::SAI_BCLRFR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SAI_BCLRFRPack  = Register<0x4001583C, 32, WriteMode, SAI1SAI_BCLRFRBase, T...> ;
  ...
  struct SAI1SAI_PDMCRBase {} ;

  struct SAI_PDMCR : public RegisterBase<0x40015844, 32, ReadWriteMode>
  {
    using PDMEN = SAI1_SAI_PDMCR_PDMEN_Values<SAI1::SAI_PDMCR, 0, 1, ReadWriteMode, SAI1SAI_PDMCRBase> ;
    using MICNBR = SAI1_SAI_PDMCR_MICNBR_Values<SAI1::SAI_PDMCR, 4, 2, ReadWriteMode, SAI1SAI_PDMCRBase> ;
    using CKEN1 = SAI1_SAI_PDMCR_CKEN1_Values<SAI1::SAI_PDMCR, 8, 1, ReadWriteMode, SAI1SAI_PDMCRBase> ;
    using CKEN2 = SAI1_SAI_PDMCR_CKEN2_Values<SAI1::SAI_PDMCR, 9, 1, ReadWriteMode, SAI1SAI_PDMCRBase> ;
    using CKEN3 = SAI1_SAI_PDMCR_CKEN3_Values<SAI1::SAI_PDMCR, 10, 1, ReadWriteMode, SAI1SAI_PDMCRBase> ;
    using CKEN4 = SAI1_SAI_PDMCR_CKEN4_Values<SAI1::SAI_PDMCR, 11, 1, ReadWriteMode, SAI1SAI_PDMCRBase> ;
    using FieldValues = SAI1_SAI_PDMCR_CKEN4_Values<SAI1::SAI_PDMCR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SAI_PDMCRPack  = Register<0x40015844, 32, ReadWriteMode, SAI1SAI_PDMCRBase, T...> ;

  struct SAI1SAI_PDMDLYBase {} ;

  struct SAI_PDMDLY : public RegisterBase<0x40015848, 32, ReadWriteMode>
  {
    using DLYM1L = SAI1_SAI_PDMDLY_DLYM1L_Values<SAI1::SAI_PDMDLY, 0, 3, ReadWriteMode, SAI1SAI_PDMDLYBase> ;
    using DLYM1R = SAI1_SAI_PDMDLY_DLYM1R_Values<SAI1::SAI_PDMDLY, 4, 3, ReadWriteMode, SAI1SAI_PDMDLYBase> ;
    using DLYM2L = SAI1_SAI_PDMDLY_DLYM2L_Values<SAI1::SAI_PDMDLY, 8, 3, ReadWriteMode, SAI1SAI_PDMDLYBase> ;
    using DLYM2R = SAI1_SAI_PDMDLY_DLYM2R_Values<SAI1::SAI_PDMDLY, 12, 3, ReadWriteMode, SAI1SAI_PDMDLYBase> ;
    using DLYM3L = SAI1_SAI_PDMDLY_DLYM3L_Values<SAI1::SAI_PDMDLY, 16, 3, ReadWriteMode, SAI1SAI_PDMDLYBase> ;
    using DLYM3R = SAI1_SAI_PDMDLY_DLYM3R_Values<SAI1::SAI_PDMDLY, 20, 3, ReadWriteMode, SAI1SAI_PDMDLYBase> ;
    using DLYM4L = SAI1_SAI_PDMDLY_DLYM4L_Values<SAI1::SAI_PDMDLY, 24, 3, ReadWriteMode, SAI1SAI_PDMDLYBase> ;
    using DLYM4R = SAI1_SAI_PDMDLY_DLYM4R_Values<SAI1::SAI_PDMDLY, 28, 3, ReadWriteMode, SAI1SAI_PDMDLYBase> ;
    using FieldValues = SAI1_SAI_PDMDLY_DLYM4R_Values<SAI1::SAI_PDMDLY, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SAI_PDMDLYPack  = Register<0x40015848, 32, ReadWriteMode, SAI1SAI_PDMDLYBase, T...> ;
