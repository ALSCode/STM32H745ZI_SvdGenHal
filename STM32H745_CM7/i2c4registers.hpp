...
*
* Details       : I2C. This header file is auto-generated for STM32H745_CM7
*                 device.
*
*
*******************************************************************************/
...
struct I2C4
{
  ...
  struct CR1 : public RegisterBase<0x58001C00, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CR1Pack  = Register<0x58001C00, 32, ReadWriteMode, I2C4CR1Base, T...> ;

  struct I2C4CR2Base {} ;

  struct CR2 : public RegisterBase<0x58001C04, 32, ReadWriteMode>
  {
    using SADD0 = I2C4_CR2_SADD0_Values<I2C4::CR2, 0, 1, ReadWriteMode, I2C4CR2Base> ;
    using SADD1 = I2C4_CR2_SADD1_Values<I2C4::CR2, 1, 1, ReadWriteMode, I2C4CR2Base> ;
    using SADD2 = I2C4_CR2_SADD2_Values<I2C4::CR2, 2, 1, ReadWriteMode, I2C4CR2Base> ;
    using SADD3 = I2C4_CR2_SADD3_Values<I2C4::CR2, 3, 1, ReadWriteMode, I2C4CR2Base> ;
    using SADD4 = I2C4_CR2_SADD4_Values<I2C4::CR2, 4, 1, ReadWriteMode, I2C4CR2Base> ;
    using SADD5 = I2C4_CR2_SADD5_Values<I2C4::CR2, 5, 1, ReadWriteMode, I2C4CR2Base> ;
    using SADD6 = I2C4_CR2_SADD6_Values<I2C4::CR2, 6, 1, ReadWriteMode, I2C4CR2Base> ;
    using SADD7 = I2C4_CR2_SADD7_Values<I2C4::CR2, 7, 1, ReadWriteMode, I2C4CR2Base> ;
    using SADD8 = I2C4_CR2_SADD8_Values<I2C4::CR2, 8, 1, ReadWriteMode, I2C4CR2Base> ;
    using SADD9 = I2C4_CR2_SADD9_Values<I2C4::CR2, 9, 1, ReadWriteMode, I2C4CR2Base> ;
    ...
    using FieldValues = I2C4_CR2_PECBYTE_Values<I2C4::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CR2Pack  = Register<0x58001C04, 32, ReadWriteMode, I2C4CR2Base, T...> ;

  struct I2C4OAR1Base {} ;

  struct OAR1 : public RegisterBase<0x58001C08, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OAR1Pack  = Register<0x58001C08, 32, ReadWriteMode, I2C4OAR1Base, T...> ;

  struct I2C4OAR2Base {} ;

  struct OAR2 : public RegisterBase<0x58001C0C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OAR2Pack  = Register<0x58001C0C, 32, ReadWriteMode, I2C4OAR2Base, T...> ;

  struct I2C4TIMINGRBase {} ;

  struct TIMINGR : public RegisterBase<0x58001C10, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using TIMINGRPack  = Register<0x58001C10, 32, ReadWriteMode, I2C4TIMINGRBase, T...> ;

  struct I2C4TIMEOUTRBase {} ;

  struct TIMEOUTR : public RegisterBase<0x58001C14, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using TIMEOUTRPack  = Register<0x58001C14, 32, ReadWriteMode, I2C4TIMEOUTRBase, T...> ;

  struct I2C4ISRBase {} ;

  struct ISR : public RegisterBase<0x58001C18, 32, ReadWriteMode>
  {
    ...
    using FieldValues = I2C4_ISR_ADDCODE_Values<I2C4::ISR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ISRPack  = Register<0x58001C18, 32, ReadWriteMode, I2C4ISRBase, T...> ;

  struct I2C4ICRBase {} ;

  struct ICR : public RegisterBase<0x58001C1C, 32, WriteMode>
  {
    ...
    using FieldValues = I2C4_ICR_ALERTCF_Values<I2C4::ICR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ICRPack  = Register<0x58001C1C, 32, WriteMode, I2C4ICRBase, T...> ;

  struct I2C4PECRBase {} ;

  struct PECR : public RegisterBase<0x58001C20, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using PECRPack  = Register<0x58001C20, 32, ReadMode, I2C4PECRBase, T...> ;

  struct I2C4RXDRBase {} ;

  struct RXDR : public RegisterBase<0x58001C24, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using RXDRPack  = Register<0x58001C24, 32, ReadMode, I2C4RXDRBase, T...> ;

  struct I2C4TXDRBase {} ;

  struct TXDR : public RegisterBase<0x58001C28, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using TXDRPack  = Register<0x58001C28, 32, ReadWriteMode, I2C4TXDRBase, T...> ;
