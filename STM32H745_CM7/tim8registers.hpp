...
struct TIM8
{
  ...
  struct SMCR : public RegisterBase<0x40010408, 32, ReadWriteMode>
  {
    ...
    using SMS_3 = TIM8_SMCR_SMS_3_Values<TIM8::SMCR, 16, 1, ReadWriteMode, TIM8SMCRBase> ;
    using TS_4_3 = TIM8_SMCR_TS_4_3_Values<TIM8::SMCR, 20, 2, ReadWriteMode, TIM8SMCRBase> ;
    using FieldValues = TIM8_SMCR_TS_4_3_Values<TIM8::SMCR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using CC6IF = TIM8_SR_CC6IF_Values<TIM8::SR, 17, 1, ReadWriteMode, TIM8SRBase> ;
    using CC5IF = TIM8_SR_CC5IF_Values<TIM8::SR, 16, 1, ReadWriteMode, TIM8SRBase> ;
    using SBIF = TIM8_SR_SBIF_Values<TIM8::SR, 13, 1, ReadWriteMode, TIM8SRBase> ;
  ...
  struct CCMR2_Output : public RegisterBase<0x4001041C, 32, ReadWriteMode>
  {
    ...
    using OC4M_4 = TIM8_CCMR2_Output_OC4M_4_Values<TIM8::CCMR2_Output, 24, 1, ReadWriteMode, TIM8CCMR2_OutputBase> ;
    using FieldValues = TIM8_CCMR2_Output_OC4M_4_Values<TIM8::CCMR2_Output, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct CCMR3_Output : public RegisterBase<0x40010454, 32, ReadWriteMode>
  {
    ...
    using OC5M3 = TIM8_CCMR3_Output_OC5M3_Values<TIM8::CCMR3_Output, 16, 1, ReadWriteMode, TIM8CCMR3_OutputBase> ;
    using OC6M3 = TIM8_CCMR3_Output_OC6M3_Values<TIM8::CCMR3_Output, 24, 1, ReadWriteMode, TIM8CCMR3_OutputBase> ;
    using FieldValues = TIM8_CCMR3_Output_OC6M3_Values<TIM8::CCMR3_Output, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CCMR3_OutputPack  = Register<0x40010454, 32, ReadWriteMode, TIM8CCMR3_OutputBase, T...> ;

  struct TIM8CCR5Base {} ;

  struct CCR5 : public RegisterBase<0x40010458, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CCR5Pack  = Register<0x40010458, 32, ReadWriteMode, TIM8CCR5Base, T...> ;

  struct TIM8CRR6Base {} ;

  struct CRR6 : public RegisterBase<0x4001045C, 32, ReadWriteMode>
  {
    using CCR6 = TIM8_CRR6_CCR6_Values<TIM8::CRR6, 0, 16, ReadWriteMode, TIM8CRR6Base> ;
    using FieldValues = TIM8_CRR6_CCR6_Values<TIM8::CRR6, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CRR6Pack  = Register<0x4001045C, 32, ReadWriteMode, TIM8CRR6Base, T...> ;

  struct TIM8AF1Base {} ;

  struct AF1 : public RegisterBase<0x40010460, 32, ReadWriteMode>
  {
    using BKINE = TIM8_AF1_BKINE_Values<TIM8::AF1, 0, 1, ReadWriteMode, TIM8AF1Base> ;
    using BKCMP1E = TIM8_AF1_BKCMP1E_Values<TIM8::AF1, 1, 1, ReadWriteMode, TIM8AF1Base> ;
    using BKCMP2E = TIM8_AF1_BKCMP2E_Values<TIM8::AF1, 2, 1, ReadWriteMode, TIM8AF1Base> ;
    using BKDF1BK0E = TIM8_AF1_BKDF1BK0E_Values<TIM8::AF1, 8, 1, ReadWriteMode, TIM8AF1Base> ;
    using BKINP = TIM8_AF1_BKINP_Values<TIM8::AF1, 9, 1, ReadWriteMode, TIM8AF1Base> ;
    using BKCMP1P = TIM8_AF1_BKCMP1P_Values<TIM8::AF1, 10, 1, ReadWriteMode, TIM8AF1Base> ;
    using BKCMP2P = TIM8_AF1_BKCMP2P_Values<TIM8::AF1, 11, 1, ReadWriteMode, TIM8AF1Base> ;
    using ETRSEL = TIM8_AF1_ETRSEL_Values<TIM8::AF1, 14, 4, ReadWriteMode, TIM8AF1Base> ;
    using FieldValues = TIM8_AF1_ETRSEL_Values<TIM8::AF1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AF1Pack  = Register<0x40010460, 32, ReadWriteMode, TIM8AF1Base, T...> ;

  struct TIM8AF2Base {} ;

  struct AF2 : public RegisterBase<0x40010464, 32, ReadWriteMode>
  {
    using BK2INE = TIM8_AF2_BK2INE_Values<TIM8::AF2, 0, 1, ReadWriteMode, TIM8AF2Base> ;
    using BK2CMP1E = TIM8_AF2_BK2CMP1E_Values<TIM8::AF2, 1, 1, ReadWriteMode, TIM8AF2Base> ;
    using BK2CMP2E = TIM8_AF2_BK2CMP2E_Values<TIM8::AF2, 2, 1, ReadWriteMode, TIM8AF2Base> ;
    using BK2DF1BK1E = TIM8_AF2_BK2DF1BK1E_Values<TIM8::AF2, 8, 1, ReadWriteMode, TIM8AF2Base> ;
    using BK2INP = TIM8_AF2_BK2INP_Values<TIM8::AF2, 9, 1, ReadWriteMode, TIM8AF2Base> ;
    using BK2CMP1P = TIM8_AF2_BK2CMP1P_Values<TIM8::AF2, 10, 1, ReadWriteMode, TIM8AF2Base> ;
    using BK2CMP2P = TIM8_AF2_BK2CMP2P_Values<TIM8::AF2, 11, 1, ReadWriteMode, TIM8AF2Base> ;
    using FieldValues = TIM8_AF2_BK2CMP2P_Values<TIM8::AF2, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AF2Pack  = Register<0x40010464, 32, ReadWriteMode, TIM8AF2Base, T...> ;

  struct TIM8TISELBase {} ;

  struct TISEL : public RegisterBase<0x40010468, 32, ReadWriteMode>
  {
    using TI1SEL = TIM8_TISEL_TI1SEL_Values<TIM8::TISEL, 0, 4, ReadWriteMode, TIM8TISELBase> ;
    using TI2SEL = TIM8_TISEL_TI2SEL_Values<TIM8::TISEL, 8, 4, ReadWriteMode, TIM8TISELBase> ;
    using TI3SEL = TIM8_TISEL_TI3SEL_Values<TIM8::TISEL, 16, 4, ReadWriteMode, TIM8TISELBase> ;
    using TI4SEL = TIM8_TISEL_TI4SEL_Values<TIM8::TISEL, 24, 4, ReadWriteMode, TIM8TISELBase> ;
    using FieldValues = TIM8_TISEL_TI4SEL_Values<TIM8::TISEL, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using TISELPack  = Register<0x40010468, 32, ReadWriteMode, TIM8TISELBase, T...> ;
