...
struct I2C2
{
  ...
  struct CR2 : public RegisterBase<0x40005804, 32, ReadWriteMode>
  {
    ...
    using SADD1 = I2C2_CR2_SADD1_Values<I2C2::CR2, 1, 1, ReadWriteMode, I2C2CR2Base> ;
    using SADD2 = I2C2_CR2_SADD2_Values<I2C2::CR2, 2, 1, ReadWriteMode, I2C2CR2Base> ;
    using SADD3 = I2C2_CR2_SADD3_Values<I2C2::CR2, 3, 1, ReadWriteMode, I2C2CR2Base> ;
    using SADD4 = I2C2_CR2_SADD4_Values<I2C2::CR2, 4, 1, ReadWriteMode, I2C2CR2Base> ;
    using SADD5 = I2C2_CR2_SADD5_Values<I2C2::CR2, 5, 1, ReadWriteMode, I2C2CR2Base> ;
    using SADD6 = I2C2_CR2_SADD6_Values<I2C2::CR2, 6, 1, ReadWriteMode, I2C2CR2Base> ;
    using SADD7 = I2C2_CR2_SADD7_Values<I2C2::CR2, 7, 1, ReadWriteMode, I2C2CR2Base> ;
    using SADD8 = I2C2_CR2_SADD8_Values<I2C2::CR2, 8, 1, ReadWriteMode, I2C2CR2Base> ;
    using SADD9 = I2C2_CR2_SADD9_Values<I2C2::CR2, 9, 1, ReadWriteMode, I2C2CR2Base> ;
    ...
    using FieldValues = I2C2_CR2_PECBYTE_Values<I2C2::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct ISR : public RegisterBase<0x40005818, 32, ReadWriteMode>
  {
    ...
    using FieldValues = I2C2_ISR_ADDCODE_Values<I2C2::ISR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct ICR : public RegisterBase<0x4000581C, 32, WriteMode>
  {
    ...
    using FieldValues = I2C2_ICR_ALERTCF_Values<I2C2::ICR, 0, 0, NoAccess, NoAccess> ;
  } ;
