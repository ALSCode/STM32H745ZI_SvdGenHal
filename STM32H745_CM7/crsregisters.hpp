...
*
* Details       : CRS. This header file is auto-generated for STM32H745_CM7
*                 device.
*
*
*******************************************************************************/
...
struct CRS
{
  ...
  struct CR : public RegisterBase<0x40008400, 32, ReadWriteMode>
  {
    ...
    using SWSYNC = CRS_CR_SWSYNC_Values<CRS::CR, 7, 1, ReadMode, CRSCRBase> ;
  ...
  template<typename... T> 
  using CRPack  = Register<0x40008400, 32, ReadWriteMode, CRSCRBase, T...> ;

  struct CRSCFGRBase {} ;

  struct CFGR : public RegisterBase<0x40008404, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CFGRPack  = Register<0x40008404, 32, ReadWriteMode, CRSCFGRBase, T...> ;

  struct CRSISRBase {} ;

  struct ISR : public RegisterBase<0x40008408, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using ISRPack  = Register<0x40008408, 32, ReadMode, CRSISRBase, T...> ;

  struct CRSICRBase {} ;

  struct ICR : public RegisterBase<0x4000840C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ICRPack  = Register<0x4000840C, 32, ReadWriteMode, CRSICRBase, T...> ;
