...
*
* Details       : QUADSPI. This header file is auto-generated for STM32H745_CM7
*                 device.
*
*
*******************************************************************************/
...
struct QUADSPI
{
  ...
  struct CR : public RegisterBase<0x52005000, 32, ReadWriteMode>
  {
    ...
    using FieldValues = QUADSPI_CR_PRESCALER_Values<QUADSPI::CR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CRPack  = Register<0x52005000, 32, ReadWriteMode, QUADSPICRBase, T...> ;

  struct QUADSPIDCRBase {} ;

  struct DCR : public RegisterBase<0x52005004, 32, ReadWriteMode>
  {
    ...
    using FieldValues = QUADSPI_DCR_FSIZE_Values<QUADSPI::DCR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using DCRPack  = Register<0x52005004, 32, ReadWriteMode, QUADSPIDCRBase, T...> ;

  struct QUADSPISRBase {} ;

  struct SR : public RegisterBase<0x52005008, 32, ReadMode>
  {
    ...
    using FieldValues = QUADSPI_SR_FLEVEL_Values<QUADSPI::SR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SRPack  = Register<0x52005008, 32, ReadMode, QUADSPISRBase, T...> ;

  struct QUADSPIFCRBase {} ;

  struct FCR : public RegisterBase<0x5200500C, 32, ReadWriteMode>
  {
    ...
    using FieldValues = QUADSPI_FCR_CTOF_Values<QUADSPI::FCR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using FCRPack  = Register<0x5200500C, 32, ReadWriteMode, QUADSPIFCRBase, T...> ;

  struct QUADSPIDLRBase {} ;

  struct DLR : public RegisterBase<0x52005010, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using DLRPack  = Register<0x52005010, 32, ReadWriteMode, QUADSPIDLRBase, T...> ;

  struct QUADSPICCRBase {} ;

  struct CCR : public RegisterBase<0x52005014, 32, ReadWriteMode>
  {
    ...
    using FieldValues = QUADSPI_CCR_DDRM_Values<QUADSPI::CCR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CCRPack  = Register<0x52005014, 32, ReadWriteMode, QUADSPICCRBase, T...> ;

  struct QUADSPIARBase {} ;

  struct AR : public RegisterBase<0x52005018, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ARPack  = Register<0x52005018, 32, ReadWriteMode, QUADSPIARBase, T...> ;

  struct QUADSPIABRBase {} ;

  struct ABR : public RegisterBase<0x5200501C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ABRPack  = Register<0x5200501C, 32, ReadWriteMode, QUADSPIABRBase, T...> ;

  struct QUADSPIDRBase {} ;

  struct DR : public RegisterBase<0x52005020, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using DRPack  = Register<0x52005020, 32, ReadWriteMode, QUADSPIDRBase, T...> ;

  struct QUADSPIPSMKRBase {} ;

  struct PSMKR : public RegisterBase<0x52005024, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using PSMKRPack  = Register<0x52005024, 32, ReadWriteMode, QUADSPIPSMKRBase, T...> ;

  struct QUADSPIPSMARBase {} ;

  struct PSMAR : public RegisterBase<0x52005028, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using PSMARPack  = Register<0x52005028, 32, ReadWriteMode, QUADSPIPSMARBase, T...> ;

  struct QUADSPIPIRBase {} ;

  struct PIR : public RegisterBase<0x5200502C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using PIRPack  = Register<0x5200502C, 32, ReadWriteMode, QUADSPIPIRBase, T...> ;

  struct QUADSPILPTRBase {} ;

  struct LPTR : public RegisterBase<0x52005030, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using LPTRPack  = Register<0x52005030, 32, ReadWriteMode, QUADSPILPTRBase, T...> ;
