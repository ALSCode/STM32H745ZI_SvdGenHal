...
struct TIM16
{
  ...
  struct DIER : public RegisterBase<0x4001440C, 32, ReadWriteMode>
  {
    ...
    using FieldValues = TIM16_DIER_COMDE_Values<TIM16::DIER, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct TIM16TIM16_AF1Base {} ;

  struct TIM16_AF1 : public RegisterBase<0x40014460, 32, ReadWriteMode>
  {
    using BKINE = TIM16_TIM16_AF1_BKINE_Values<TIM16::TIM16_AF1, 0, 1, ReadWriteMode, TIM16TIM16_AF1Base> ;
    using BKCMP1E = TIM16_TIM16_AF1_BKCMP1E_Values<TIM16::TIM16_AF1, 1, 1, ReadWriteMode, TIM16TIM16_AF1Base> ;
    using BKCMP2E = TIM16_TIM16_AF1_BKCMP2E_Values<TIM16::TIM16_AF1, 2, 1, ReadWriteMode, TIM16TIM16_AF1Base> ;
    using BKDFBK1E = TIM16_TIM16_AF1_BKDFBK1E_Values<TIM16::TIM16_AF1, 8, 1, ReadWriteMode, TIM16TIM16_AF1Base> ;
    using BKINP = TIM16_TIM16_AF1_BKINP_Values<TIM16::TIM16_AF1, 9, 1, ReadWriteMode, TIM16TIM16_AF1Base> ;
    using BKCMP1P = TIM16_TIM16_AF1_BKCMP1P_Values<TIM16::TIM16_AF1, 10, 1, ReadWriteMode, TIM16TIM16_AF1Base> ;
    using BKCMP2P = TIM16_TIM16_AF1_BKCMP2P_Values<TIM16::TIM16_AF1, 11, 1, ReadWriteMode, TIM16TIM16_AF1Base> ;
    using FieldValues = TIM16_TIM16_AF1_BKCMP2P_Values<TIM16::TIM16_AF1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using TIM16_AF1Pack  = Register<0x40014460, 32, ReadWriteMode, TIM16TIM16_AF1Base, T...> ;

  struct TIM16TIM16_TISELBase {} ;

  struct TIM16_TISEL : public RegisterBase<0x40014468, 32, ReadWriteMode>
  {
    using TI1SEL = TIM16_TIM16_TISEL_TI1SEL_Values<TIM16::TIM16_TISEL, 0, 4, ReadWriteMode, TIM16TIM16_TISELBase> ;
    using FieldValues = TIM16_TIM16_TISEL_TI1SEL_Values<TIM16::TIM16_TISEL, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using TIM16_TISELPack  = Register<0x40014468, 32, ReadWriteMode, TIM16TIM16_TISELBase, T...> ;
