...
struct LPTIM1
{
  ...
  struct ISR : public RegisterBase<0x40002400, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using ISRPack  = Register<0x40002400, 32, ReadMode, LPTIM1ISRBase, T...> ;

  struct LPTIM1ICRBase {} ;

  struct ICR : public RegisterBase<0x40002404, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using ICRPack  = Register<0x40002404, 32, WriteMode, LPTIM1ICRBase, T...> ;

  struct LPTIM1IERBase {} ;

  struct IER : public RegisterBase<0x40002408, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using IERPack  = Register<0x40002408, 32, ReadWriteMode, LPTIM1IERBase, T...> ;

  struct LPTIM1CFGRBase {} ;

  struct CFGR : public RegisterBase<0x4000240C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CFGRPack  = Register<0x4000240C, 32, ReadWriteMode, LPTIM1CFGRBase, T...> ;

  struct LPTIM1CRBase {} ;

  struct CR : public RegisterBase<0x40002410, 32, ReadWriteMode>
  {
    ...
    using FieldValues = LPTIM1_CR_RSTARE_Values<LPTIM1::CR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CRPack  = Register<0x40002410, 32, ReadWriteMode, LPTIM1CRBase, T...> ;

  struct LPTIM1CMPBase {} ;

  struct CMP : public RegisterBase<0x40002414, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CMPPack  = Register<0x40002414, 32, ReadWriteMode, LPTIM1CMPBase, T...> ;

  struct LPTIM1ARRBase {} ;

  struct ARR : public RegisterBase<0x40002418, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ARRPack  = Register<0x40002418, 32, ReadWriteMode, LPTIM1ARRBase, T...> ;

  struct LPTIM1CNTBase {} ;

  struct CNT : public RegisterBase<0x4000241C, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using CNTPack  = Register<0x4000241C, 32, ReadMode, LPTIM1CNTBase, T...> ;

  struct LPTIM1CFGR2Base {} ;

  struct CFGR2 : public RegisterBase<0x40002424, 32, ReadWriteMode>
  {
    using IN1SEL = LPTIM1_CFGR2_IN1SEL_Values<LPTIM1::CFGR2, 0, 2, ReadWriteMode, LPTIM1CFGR2Base> ;
    using IN2SEL = LPTIM1_CFGR2_IN2SEL_Values<LPTIM1::CFGR2, 4, 2, ReadWriteMode, LPTIM1CFGR2Base> ;
    using FieldValues = LPTIM1_CFGR2_IN2SEL_Values<LPTIM1::CFGR2, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CFGR2Pack  = Register<0x40002424, 32, ReadWriteMode, LPTIM1CFGR2Base, T...> ;
