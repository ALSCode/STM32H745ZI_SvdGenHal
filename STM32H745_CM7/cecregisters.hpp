...
*
* Details       : CEC. This header file is auto-generated for STM32H745_CM7
*                 device.
*
*
*******************************************************************************/
...
struct CEC
{
  ...
  struct CR : public RegisterBase<0x40006C00, 32, ReadWriteMode>
  {
    ...
    using FieldValues = CEC_CR_TXEOM_Values<CEC::CR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CRPack  = Register<0x40006C00, 32, ReadWriteMode, CECCRBase, T...> ;

  struct CECCFGRBase {} ;

  struct CFGR : public RegisterBase<0x40006C04, 32, ReadWriteMode>
  {
    using SFT = CEC_CFGR_SFT_Values<CEC::CFGR, 0, 3, ReadWriteMode, CECCFGRBase> ;
    using RXTOL = CEC_CFGR_RXTOL_Values<CEC::CFGR, 3, 1, ReadWriteMode, CECCFGRBase> ;
    using BRESTP = CEC_CFGR_BRESTP_Values<CEC::CFGR, 4, 1, ReadWriteMode, CECCFGRBase> ;
    using BREGEN = CEC_CFGR_BREGEN_Values<CEC::CFGR, 5, 1, ReadWriteMode, CECCFGRBase> ;
    using LBPEGEN = CEC_CFGR_LBPEGEN_Values<CEC::CFGR, 6, 1, ReadWriteMode, CECCFGRBase> ;
    using BRDNOGEN = CEC_CFGR_BRDNOGEN_Values<CEC::CFGR, 7, 1, ReadWriteMode, CECCFGRBase> ;
    using SFTOPT = CEC_CFGR_SFTOPT_Values<CEC::CFGR, 8, 1, ReadWriteMode, CECCFGRBase> ;
    using OAR = CEC_CFGR_OAR_Values<CEC::CFGR, 16, 15, ReadWriteMode, CECCFGRBase> ;
    using LSTN = CEC_CFGR_LSTN_Values<CEC::CFGR, 31, 1, ReadWriteMode, CECCFGRBase> ;
    using FieldValues = CEC_CFGR_LSTN_Values<CEC::CFGR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CFGRPack  = Register<0x40006C04, 32, ReadWriteMode, CECCFGRBase, T...> ;

  struct CECTXDRBase {} ;

  struct TXDR : public RegisterBase<0x40006C08, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using TXDRPack  = Register<0x40006C08, 32, WriteMode, CECTXDRBase, T...> ;

  struct CECRXDRBase {} ;

  struct RXDR : public RegisterBase<0x40006C0C, 32, ReadMode>
  {
    using RXD = CEC_RXDR_RXD_Values<CEC::RXDR, 0, 8, ReadMode, CECRXDRBase> ;
    using FieldValues = CEC_RXDR_RXD_Values<CEC::RXDR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using RXDRPack  = Register<0x40006C0C, 32, ReadMode, CECRXDRBase, T...> ;

  struct CECISRBase {} ;

  struct ISR : public RegisterBase<0x40006C10, 32, ReadWriteMode>
  {
    ...
    using FieldValues = CEC_ISR_TXACKE_Values<CEC::ISR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ISRPack  = Register<0x40006C10, 32, ReadWriteMode, CECISRBase, T...> ;

  struct CECIERBase {} ;

  struct IER : public RegisterBase<0x40006C14, 32, ReadWriteMode>
  {
    ...
    using FieldValues = CEC_IER_TXACKIE_Values<CEC::IER, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using IERPack  = Register<0x40006C14, 32, ReadWriteMode, CECIERBase, T...> ;
