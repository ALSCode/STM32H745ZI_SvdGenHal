...
struct USART3
{
  ...
  {
    using RXFFIE = USART3_CR1_RXFFIE_Values<USART3::CR1, 31, 1, ReadWriteMode, USART3CR1Base> ;
    using TXFEIE = USART3_CR1_TXFEIE_Values<USART3::CR1, 30, 1, ReadWriteMode, USART3CR1Base> ;
    using FIFOEN = USART3_CR1_FIFOEN_Values<USART3::CR1, 29, 1, ReadWriteMode, USART3CR1Base> ;
  ...
  struct CR2 : public RegisterBase<0x40004804, 32, ReadWriteMode>
  {
    ...
    using DIS_NSS = USART3_CR2_DIS_NSS_Values<USART3::CR2, 3, 1, ReadWriteMode, USART3CR2Base> ;
    using SLVEN = USART3_CR2_SLVEN_Values<USART3::CR2, 0, 1, ReadWriteMode, USART3CR2Base> ;
    using FieldValues = USART3_CR2_SLVEN_Values<USART3::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using TXFTCFG = USART3_CR3_TXFTCFG_Values<USART3::CR3, 29, 3, ReadWriteMode, USART3CR3Base> ;
    using RXFTIE = USART3_CR3_RXFTIE_Values<USART3::CR3, 28, 1, ReadWriteMode, USART3CR3Base> ;
    using RXFTCFG = USART3_CR3_RXFTCFG_Values<USART3::CR3, 25, 3, ReadWriteMode, USART3CR3Base> ;
    using TCBGTIE = USART3_CR3_TCBGTIE_Values<USART3::CR3, 24, 1, ReadWriteMode, USART3CR3Base> ;
    using TXFTIE = USART3_CR3_TXFTIE_Values<USART3::CR3, 23, 1, ReadWriteMode, USART3CR3Base> ;
  ...
  {
    using BRR_4_15 = USART3_BRR_BRR_4_15_Values<USART3::BRR, 4, 12, ReadWriteMode, USART3BRRBase> ;
    using BRR_0_3 = USART3_BRR_BRR_0_3_Values<USART3::BRR, 0, 4, ReadWriteMode, USART3BRRBase> ;
    using FieldValues = USART3_BRR_BRR_0_3_Values<USART3::BRR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using TXFT = USART3_ISR_TXFT_Values<USART3::ISR, 27, 1, ReadMode, USART3ISRBase> ;
    using RXFT = USART3_ISR_RXFT_Values<USART3::ISR, 26, 1, ReadMode, USART3ISRBase> ;
    using TCBGT = USART3_ISR_TCBGT_Values<USART3::ISR, 25, 1, ReadMode, USART3ISRBase> ;
    using RXFF = USART3_ISR_RXFF_Values<USART3::ISR, 24, 1, ReadMode, USART3ISRBase> ;
    using TXFE = USART3_ISR_TXFE_Values<USART3::ISR, 23, 1, ReadMode, USART3ISRBase> ;
    ...
    using UDR = USART3_ISR_UDR_Values<USART3::ISR, 13, 1, ReadMode, USART3ISRBase> ;
  ...
  struct ICR : public RegisterBase<0x40004820, 32, WriteMode>
  {
    ...
    using UDRCF = USART3_ICR_UDRCF_Values<USART3::ICR, 13, 1, WriteMode, USART3ICRBase> ;
    ...
    using TCBGTC = USART3_ICR_TCBGTC_Values<USART3::ICR, 7, 1, WriteMode, USART3ICRBase> ;
    using TCCF = USART3_ICR_TCCF_Values<USART3::ICR, 6, 1, WriteMode, USART3ICRBase> ;
    using TXFECF = USART3_ICR_TXFECF_Values<USART3::ICR, 5, 1, WriteMode, USART3ICRBase> ;
  ...
  struct USART3PRESCBase {} ;

  struct PRESC : public RegisterBase<0x4000482C, 32, ReadWriteMode>
  {
    using PRESCALER = USART3_PRESC_PRESCALER_Values<USART3::PRESC, 0, 4, ReadWriteMode, USART3PRESCBase> ;
    using FieldValues = USART3_PRESC_PRESCALER_Values<USART3::PRESC, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using PRESCPack  = Register<0x4000482C, 32, ReadWriteMode, USART3PRESCBase, T...> ;
