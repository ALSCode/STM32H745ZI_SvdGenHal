...
struct LTDC
{
  ...
  struct SSCR : public RegisterBase<0x50001008, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SSCRPack  = Register<0x50001008, 32, ReadWriteMode, LTDCSSCRBase, T...> ;

  struct LTDCBPCRBase {} ;

  struct BPCR : public RegisterBase<0x5000100C, 32, ReadWriteMode>
  {
    using AHBP = LTDC_BPCR_AHBP_Values<LTDC::BPCR, 16, 12, ReadWriteMode, LTDCBPCRBase> ;
  ...
  template<typename... T> 
  using BPCRPack  = Register<0x5000100C, 32, ReadWriteMode, LTDCBPCRBase, T...> ;

  struct LTDCAWCRBase {} ;

  struct AWCR : public RegisterBase<0x50001010, 32, ReadWriteMode>
  {
    using AAV = LTDC_AWCR_AAV_Values<LTDC::AWCR, 16, 12, ReadWriteMode, LTDCAWCRBase> ;
  ...
  template<typename... T> 
  using AWCRPack  = Register<0x50001010, 32, ReadWriteMode, LTDCAWCRBase, T...> ;

  struct LTDCTWCRBase {} ;

  struct TWCR : public RegisterBase<0x50001014, 32, ReadWriteMode>
  {
    using TOTALW = LTDC_TWCR_TOTALW_Values<LTDC::TWCR, 16, 12, ReadWriteMode, LTDCTWCRBase> ;
  ...
  template<typename... T> 
  using TWCRPack  = Register<0x50001014, 32, ReadWriteMode, LTDCTWCRBase, T...> ;

  struct LTDCGCRBase {} ;

  struct GCR : public RegisterBase<0x50001018, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using GCRPack  = Register<0x50001018, 32, ReadWriteMode, LTDCGCRBase, T...> ;

  struct LTDCSRCRBase {} ;

  struct SRCR : public RegisterBase<0x50001024, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SRCRPack  = Register<0x50001024, 32, ReadWriteMode, LTDCSRCRBase, T...> ;

  struct LTDCBCCRBase {} ;

  struct BCCR : public RegisterBase<0x5000102C, 32, ReadWriteMode>
  {
    using BCBLUE = LTDC_BCCR_BCBLUE_Values<LTDC::BCCR, 0, 8, ReadWriteMode, LTDCBCCRBase> ;
    using BCGREEN = LTDC_BCCR_BCGREEN_Values<LTDC::BCCR, 8, 8, ReadWriteMode, LTDCBCCRBase> ;
    using BCRED = LTDC_BCCR_BCRED_Values<LTDC::BCCR, 16, 8, ReadWriteMode, LTDCBCCRBase> ;
    using FieldValues = LTDC_BCCR_BCRED_Values<LTDC::BCCR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using BCCRPack  = Register<0x5000102C, 32, ReadWriteMode, LTDCBCCRBase, T...> ;

  struct LTDCIERBase {} ;

  struct IER : public RegisterBase<0x50001034, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using IERPack  = Register<0x50001034, 32, ReadWriteMode, LTDCIERBase, T...> ;

  struct LTDCISRBase {} ;

  struct ISR : public RegisterBase<0x50001038, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using ISRPack  = Register<0x50001038, 32, ReadMode, LTDCISRBase, T...> ;

  struct LTDCICRBase {} ;

  struct ICR : public RegisterBase<0x5000103C, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using ICRPack  = Register<0x5000103C, 32, WriteMode, LTDCICRBase, T...> ;

  struct LTDCLIPCRBase {} ;

  struct LIPCR : public RegisterBase<0x50001040, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using LIPCRPack  = Register<0x50001040, 32, ReadWriteMode, LTDCLIPCRBase, T...> ;

  struct LTDCCPSRBase {} ;

  struct CPSR : public RegisterBase<0x50001044, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using CPSRPack  = Register<0x50001044, 32, ReadMode, LTDCCPSRBase, T...> ;

  struct LTDCCDSRBase {} ;

  struct CDSR : public RegisterBase<0x50001048, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using CDSRPack  = Register<0x50001048, 32, ReadMode, LTDCCDSRBase, T...> ;

  struct LTDCL1CRBase {} ;

  struct L1CR : public RegisterBase<0x50001084, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L1CRPack  = Register<0x50001084, 32, ReadWriteMode, LTDCL1CRBase, T...> ;

  struct LTDCL1WHPCRBase {} ;

  struct L1WHPCR : public RegisterBase<0x50001088, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L1WHPCRPack  = Register<0x50001088, 32, ReadWriteMode, LTDCL1WHPCRBase, T...> ;

  struct LTDCL1WVPCRBase {} ;

  struct L1WVPCR : public RegisterBase<0x5000108C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L1WVPCRPack  = Register<0x5000108C, 32, ReadWriteMode, LTDCL1WVPCRBase, T...> ;

  struct LTDCL1CKCRBase {} ;

  struct L1CKCR : public RegisterBase<0x50001090, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L1CKCRPack  = Register<0x50001090, 32, ReadWriteMode, LTDCL1CKCRBase, T...> ;

  struct LTDCL1PFCRBase {} ;

  struct L1PFCR : public RegisterBase<0x50001094, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L1PFCRPack  = Register<0x50001094, 32, ReadWriteMode, LTDCL1PFCRBase, T...> ;

  struct LTDCL1CACRBase {} ;

  struct L1CACR : public RegisterBase<0x50001098, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L1CACRPack  = Register<0x50001098, 32, ReadWriteMode, LTDCL1CACRBase, T...> ;

  struct LTDCL1DCCRBase {} ;

  struct L1DCCR : public RegisterBase<0x5000109C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L1DCCRPack  = Register<0x5000109C, 32, ReadWriteMode, LTDCL1DCCRBase, T...> ;

  struct LTDCL1BFCRBase {} ;

  struct L1BFCR : public RegisterBase<0x500010A0, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L1BFCRPack  = Register<0x500010A0, 32, ReadWriteMode, LTDCL1BFCRBase, T...> ;

  struct LTDCL1CFBARBase {} ;

  struct L1CFBAR : public RegisterBase<0x500010AC, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L1CFBARPack  = Register<0x500010AC, 32, ReadWriteMode, LTDCL1CFBARBase, T...> ;

  struct LTDCL1CFBLRBase {} ;

  struct L1CFBLR : public RegisterBase<0x500010B0, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L1CFBLRPack  = Register<0x500010B0, 32, ReadWriteMode, LTDCL1CFBLRBase, T...> ;

  struct LTDCL1CFBLNRBase {} ;

  struct L1CFBLNR : public RegisterBase<0x500010B4, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L1CFBLNRPack  = Register<0x500010B4, 32, ReadWriteMode, LTDCL1CFBLNRBase, T...> ;

  struct LTDCL1CLUTWRBase {} ;

  struct L1CLUTWR : public RegisterBase<0x500010C4, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using L1CLUTWRPack  = Register<0x500010C4, 32, WriteMode, LTDCL1CLUTWRBase, T...> ;

  struct LTDCL2CRBase {} ;

  struct L2CR : public RegisterBase<0x50001104, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L2CRPack  = Register<0x50001104, 32, ReadWriteMode, LTDCL2CRBase, T...> ;

  struct LTDCL2WHPCRBase {} ;

  struct L2WHPCR : public RegisterBase<0x50001108, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L2WHPCRPack  = Register<0x50001108, 32, ReadWriteMode, LTDCL2WHPCRBase, T...> ;

  struct LTDCL2WVPCRBase {} ;

  struct L2WVPCR : public RegisterBase<0x5000110C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L2WVPCRPack  = Register<0x5000110C, 32, ReadWriteMode, LTDCL2WVPCRBase, T...> ;

  struct LTDCL2CKCRBase {} ;

  struct L2CKCR : public RegisterBase<0x50001110, 32, ReadWriteMode>
  {
    using CKRED = LTDC_L2CKCR_CKRED_Values<LTDC::L2CKCR, 16, 8, ReadWriteMode, LTDCL2CKCRBase> ;
    using CKGREEN = LTDC_L2CKCR_CKGREEN_Values<LTDC::L2CKCR, 8, 8, ReadWriteMode, LTDCL2CKCRBase> ;
  ...
  template<typename... T> 
  using L2CKCRPack  = Register<0x50001110, 32, ReadWriteMode, LTDCL2CKCRBase, T...> ;

  struct LTDCL2PFCRBase {} ;

  struct L2PFCR : public RegisterBase<0x50001114, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L2PFCRPack  = Register<0x50001114, 32, ReadWriteMode, LTDCL2PFCRBase, T...> ;

  struct LTDCL2CACRBase {} ;

  struct L2CACR : public RegisterBase<0x50001118, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L2CACRPack  = Register<0x50001118, 32, ReadWriteMode, LTDCL2CACRBase, T...> ;

  struct LTDCL2DCCRBase {} ;

  struct L2DCCR : public RegisterBase<0x5000111C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L2DCCRPack  = Register<0x5000111C, 32, ReadWriteMode, LTDCL2DCCRBase, T...> ;

  struct LTDCL2BFCRBase {} ;

  struct L2BFCR : public RegisterBase<0x50001120, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L2BFCRPack  = Register<0x50001120, 32, ReadWriteMode, LTDCL2BFCRBase, T...> ;

  struct LTDCL2CFBARBase {} ;

  struct L2CFBAR : public RegisterBase<0x5000112C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L2CFBARPack  = Register<0x5000112C, 32, ReadWriteMode, LTDCL2CFBARBase, T...> ;

  struct LTDCL2CFBLRBase {} ;

  struct L2CFBLR : public RegisterBase<0x50001130, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L2CFBLRPack  = Register<0x50001130, 32, ReadWriteMode, LTDCL2CFBLRBase, T...> ;

  struct LTDCL2CFBLNRBase {} ;

  struct L2CFBLNR : public RegisterBase<0x50001134, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using L2CFBLNRPack  = Register<0x50001134, 32, ReadWriteMode, LTDCL2CFBLNRBase, T...> ;

  struct LTDCL2CLUTWRBase {} ;

  struct L2CLUTWR : public RegisterBase<0x50001144, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using L2CLUTWRPack  = Register<0x50001144, 32, WriteMode, LTDCL2CLUTWRBase, T...> ;
