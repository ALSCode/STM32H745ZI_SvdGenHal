...
struct USART6
{
  ...
  {
    using RXFFIE = USART6_CR1_RXFFIE_Values<USART6::CR1, 31, 1, ReadWriteMode, USART6CR1Base> ;
    using TXFEIE = USART6_CR1_TXFEIE_Values<USART6::CR1, 30, 1, ReadWriteMode, USART6CR1Base> ;
    using FIFOEN = USART6_CR1_FIFOEN_Values<USART6::CR1, 29, 1, ReadWriteMode, USART6CR1Base> ;
    ...
    using DEAT4 = USART6_CR1_DEAT4_Values<USART6::CR1, 25, 1, ReadWriteMode, USART6CR1Base> ;
    using DEAT3 = USART6_CR1_DEAT3_Values<USART6::CR1, 24, 1, ReadWriteMode, USART6CR1Base> ;
    using DEAT2 = USART6_CR1_DEAT2_Values<USART6::CR1, 23, 1, ReadWriteMode, USART6CR1Base> ;
    using DEAT1 = USART6_CR1_DEAT1_Values<USART6::CR1, 22, 1, ReadWriteMode, USART6CR1Base> ;
    using DEAT0 = USART6_CR1_DEAT0_Values<USART6::CR1, 21, 1, ReadWriteMode, USART6CR1Base> ;
    using DEDT4 = USART6_CR1_DEDT4_Values<USART6::CR1, 20, 1, ReadWriteMode, USART6CR1Base> ;
    using DEDT3 = USART6_CR1_DEDT3_Values<USART6::CR1, 19, 1, ReadWriteMode, USART6CR1Base> ;
    using DEDT2 = USART6_CR1_DEDT2_Values<USART6::CR1, 18, 1, ReadWriteMode, USART6CR1Base> ;
    using DEDT1 = USART6_CR1_DEDT1_Values<USART6::CR1, 17, 1, ReadWriteMode, USART6CR1Base> ;
    using DEDT0 = USART6_CR1_DEDT0_Values<USART6::CR1, 16, 1, ReadWriteMode, USART6CR1Base> ;
    ...
    using M0 = USART6_CR1_M0_Values<USART6::CR1, 12, 1, ReadWriteMode, USART6CR1Base> ;
    ...
    using FieldValues = USART6_CR1_UE_Values<USART6::CR1, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using ADD4_7 = USART6_CR2_ADD4_7_Values<USART6::CR2, 28, 4, ReadWriteMode, USART6CR2Base> ;
    using ADD0_3 = USART6_CR2_ADD0_3_Values<USART6::CR2, 24, 4, ReadWriteMode, USART6CR2Base> ;
    using RTOEN = USART6_CR2_RTOEN_Values<USART6::CR2, 23, 1, ReadWriteMode, USART6CR2Base> ;
    using ABRMOD1 = USART6_CR2_ABRMOD1_Values<USART6::CR2, 22, 1, ReadWriteMode, USART6CR2Base> ;
    using ABRMOD0 = USART6_CR2_ABRMOD0_Values<USART6::CR2, 21, 1, ReadWriteMode, USART6CR2Base> ;
    ...
    using TAINV = USART6_CR2_TAINV_Values<USART6::CR2, 18, 1, ReadWriteMode, USART6CR2Base> ;
    ...
    using DIS_NSS = USART6_CR2_DIS_NSS_Values<USART6::CR2, 3, 1, ReadWriteMode, USART6CR2Base> ;
    using SLVEN = USART6_CR2_SLVEN_Values<USART6::CR2, 0, 1, ReadWriteMode, USART6CR2Base> ;
    using FieldValues = USART6_CR2_SLVEN_Values<USART6::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using TXFTCFG = USART6_CR3_TXFTCFG_Values<USART6::CR3, 29, 3, ReadWriteMode, USART6CR3Base> ;
    using RXFTIE = USART6_CR3_RXFTIE_Values<USART6::CR3, 28, 1, ReadWriteMode, USART6CR3Base> ;
    using RXFTCFG = USART6_CR3_RXFTCFG_Values<USART6::CR3, 25, 3, ReadWriteMode, USART6CR3Base> ;
    using TCBGTIE = USART6_CR3_TCBGTIE_Values<USART6::CR3, 24, 1, ReadWriteMode, USART6CR3Base> ;
    using TXFTIE = USART6_CR3_TXFTIE_Values<USART6::CR3, 23, 1, ReadWriteMode, USART6CR3Base> ;
  ...
  {
    using BRR_4_15 = USART6_BRR_BRR_4_15_Values<USART6::BRR, 4, 12, ReadWriteMode, USART6BRRBase> ;
    using BRR_0_3 = USART6_BRR_BRR_0_3_Values<USART6::BRR, 0, 4, ReadWriteMode, USART6BRRBase> ;
    using FieldValues = USART6_BRR_BRR_0_3_Values<USART6::BRR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct RQR : public RegisterBase<0x40011418, 32, WriteMode>
  {
    using TXFRQ = USART6_RQR_TXFRQ_Values<USART6::RQR, 4, 1, WriteMode, USART6RQRBase> ;
    using RXFRQ = USART6_RQR_RXFRQ_Values<USART6::RQR, 3, 1, WriteMode, USART6RQRBase> ;
    using MMRQ = USART6_RQR_MMRQ_Values<USART6::RQR, 2, 1, WriteMode, USART6RQRBase> ;
    using SBKRQ = USART6_RQR_SBKRQ_Values<USART6::RQR, 1, 1, WriteMode, USART6RQRBase> ;
    using ABRRQ = USART6_RQR_ABRRQ_Values<USART6::RQR, 0, 1, WriteMode, USART6RQRBase> ;
    using FieldValues = USART6_RQR_ABRRQ_Values<USART6::RQR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using RQRPack  = Register<0x40011418, 32, WriteMode, USART6RQRBase, T...> ;

  struct USART6ISRBase {} ;

  struct ISR : public RegisterBase<0x4001141C, 32, ReadMode>
  {
    using TXFT = USART6_ISR_TXFT_Values<USART6::ISR, 27, 1, ReadMode, USART6ISRBase> ;
    using RXFT = USART6_ISR_RXFT_Values<USART6::ISR, 26, 1, ReadMode, USART6ISRBase> ;
    using TCBGT = USART6_ISR_TCBGT_Values<USART6::ISR, 25, 1, ReadMode, USART6ISRBase> ;
    using RXFF = USART6_ISR_RXFF_Values<USART6::ISR, 24, 1, ReadMode, USART6ISRBase> ;
    using TXFE = USART6_ISR_TXFE_Values<USART6::ISR, 23, 1, ReadMode, USART6ISRBase> ;
    ...
    using UDR = USART6_ISR_UDR_Values<USART6::ISR, 13, 1, ReadMode, USART6ISRBase> ;
  ...
  struct ICR : public RegisterBase<0x40011420, 32, WriteMode>
  {
    using WUCF = USART6_ICR_WUCF_Values<USART6::ICR, 20, 1, WriteMode, USART6ICRBase> ;
    using CMCF = USART6_ICR_CMCF_Values<USART6::ICR, 17, 1, WriteMode, USART6ICRBase> ;
    using UDRCF = USART6_ICR_UDRCF_Values<USART6::ICR, 13, 1, WriteMode, USART6ICRBase> ;
    using EOBCF = USART6_ICR_EOBCF_Values<USART6::ICR, 12, 1, WriteMode, USART6ICRBase> ;
    using RTOCF = USART6_ICR_RTOCF_Values<USART6::ICR, 11, 1, WriteMode, USART6ICRBase> ;
    using CTSCF = USART6_ICR_CTSCF_Values<USART6::ICR, 9, 1, WriteMode, USART6ICRBase> ;
    using LBDCF = USART6_ICR_LBDCF_Values<USART6::ICR, 8, 1, WriteMode, USART6ICRBase> ;
    using TCBGTC = USART6_ICR_TCBGTC_Values<USART6::ICR, 7, 1, WriteMode, USART6ICRBase> ;
    using TCCF = USART6_ICR_TCCF_Values<USART6::ICR, 6, 1, WriteMode, USART6ICRBase> ;
    using TXFECF = USART6_ICR_TXFECF_Values<USART6::ICR, 5, 1, WriteMode, USART6ICRBase> ;
    using IDLECF = USART6_ICR_IDLECF_Values<USART6::ICR, 4, 1, WriteMode, USART6ICRBase> ;
    using ORECF = USART6_ICR_ORECF_Values<USART6::ICR, 3, 1, WriteMode, USART6ICRBase> ;
    using NCF = USART6_ICR_NCF_Values<USART6::ICR, 2, 1, WriteMode, USART6ICRBase> ;
    using FECF = USART6_ICR_FECF_Values<USART6::ICR, 1, 1, WriteMode, USART6ICRBase> ;
    using PECF = USART6_ICR_PECF_Values<USART6::ICR, 0, 1, WriteMode, USART6ICRBase> ;
    using FieldValues = USART6_ICR_PECF_Values<USART6::ICR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ICRPack  = Register<0x40011420, 32, WriteMode, USART6ICRBase, T...> ;
  ...
  struct USART6PRESCBase {} ;

  struct PRESC : public RegisterBase<0x4001142C, 32, ReadWriteMode>
  {
    using PRESCALER = USART6_PRESC_PRESCALER_Values<USART6::PRESC, 0, 4, ReadWriteMode, USART6PRESCBase> ;
    using FieldValues = USART6_PRESC_PRESCALER_Values<USART6::PRESC, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using PRESCPack  = Register<0x4001142C, 32, ReadWriteMode, USART6PRESCBase, T...> ;
