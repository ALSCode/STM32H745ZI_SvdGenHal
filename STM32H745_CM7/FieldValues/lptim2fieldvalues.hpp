...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct LPTIM2_CFGR2_IN1SEL_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<LPTIM2_CFGR2_IN1SEL_Values, BaseType, 0U> ;
  using Value1 = FieldValue<LPTIM2_CFGR2_IN1SEL_Values, BaseType, 1U> ;
  using Value2 = FieldValue<LPTIM2_CFGR2_IN1SEL_Values, BaseType, 2U> ;
  using Value3 = FieldValue<LPTIM2_CFGR2_IN1SEL_Values, BaseType, 3U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct LPTIM2_CFGR2_IN2SEL_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<LPTIM2_CFGR2_IN2SEL_Values, BaseType, 0U> ;
  using Value1 = FieldValue<LPTIM2_CFGR2_IN2SEL_Values, BaseType, 1U> ;
  using Value2 = FieldValue<LPTIM2_CFGR2_IN2SEL_Values, BaseType, 2U> ;
  using Value3 = FieldValue<LPTIM2_CFGR2_IN2SEL_Values, BaseType, 3U> ;
} ;
