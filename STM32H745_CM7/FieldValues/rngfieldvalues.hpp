...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct RNG_CR_CED_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<RNG_CR_CED_Values, BaseType, 0U> ;
  using Value1 = FieldValue<RNG_CR_CED_Values, BaseType, 1U> ;
} ;
