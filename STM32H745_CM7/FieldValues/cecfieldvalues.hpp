...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct CEC_CFGR_BRDNOGEN_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<CEC_CFGR_BRDNOGEN_Values, BaseType, 0U> ;
  using Value1 = FieldValue<CEC_CFGR_BRDNOGEN_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct CEC_CFGR_SFTOPT_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<CEC_CFGR_SFTOPT_Values, BaseType, 0U> ;
  using Value1 = FieldValue<CEC_CFGR_SFTOPT_Values, BaseType, 1U> ;
} ;
...
template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct CEC_RXDR_RXD_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
} ;
