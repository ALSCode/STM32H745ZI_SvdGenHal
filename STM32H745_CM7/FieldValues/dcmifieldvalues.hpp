...
struct DCMI_CR_OELS_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<DCMI_CR_OELS_Values, BaseType, 0U> ;
  using Value1 = FieldValue<DCMI_CR_OELS_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct DCMI_CR_LSM_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<DCMI_CR_LSM_Values, BaseType, 0U> ;
  using Value1 = FieldValue<DCMI_CR_LSM_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct DCMI_CR_OEBS_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<DCMI_CR_OEBS_Values, BaseType, 0U> ;
  using Value1 = FieldValue<DCMI_CR_OEBS_Values, BaseType, 1U> ;
} ;

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct DCMI_CR_BSM_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<DCMI_CR_BSM_Values, BaseType, 0U> ;
  using Value1 = FieldValue<DCMI_CR_BSM_Values, BaseType, 1U> ;
  using Value2 = FieldValue<DCMI_CR_BSM_Values, BaseType, 2U> ;
  using Value3 = FieldValue<DCMI_CR_BSM_Values, BaseType, 3U> ;
} ;
