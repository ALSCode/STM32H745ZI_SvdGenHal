...
struct DCMI
{
  ...
  struct CR : public RegisterBase<0x48020000, 32, ReadWriteMode>
  {
    using OELS = DCMI_CR_OELS_Values<DCMI::CR, 20, 1, ReadWriteMode, DCMICRBase> ;
    using LSM = DCMI_CR_LSM_Values<DCMI::CR, 19, 1, ReadWriteMode, DCMICRBase> ;
    using OEBS = DCMI_CR_OEBS_Values<DCMI::CR, 18, 1, ReadWriteMode, DCMICRBase> ;
    using BSM = DCMI_CR_BSM_Values<DCMI::CR, 16, 2, ReadWriteMode, DCMICRBase> ;
  ...
  template<typename... T> 
  using CRPack  = Register<0x48020000, 32, ReadWriteMode, DCMICRBase, T...> ;

  struct DCMISRBase {} ;

  struct SR : public RegisterBase<0x48020004, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using SRPack  = Register<0x48020004, 32, ReadMode, DCMISRBase, T...> ;

  struct DCMIRISBase {} ;

  struct RIS : public RegisterBase<0x48020008, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using RISPack  = Register<0x48020008, 32, ReadMode, DCMIRISBase, T...> ;

  struct DCMIIERBase {} ;

  struct IER : public RegisterBase<0x4802000C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using IERPack  = Register<0x4802000C, 32, ReadWriteMode, DCMIIERBase, T...> ;

  struct DCMIMISBase {} ;

  struct MIS : public RegisterBase<0x48020010, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using MISPack  = Register<0x48020010, 32, ReadMode, DCMIMISBase, T...> ;

  struct DCMIICRBase {} ;

  struct ICR : public RegisterBase<0x48020014, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using ICRPack  = Register<0x48020014, 32, WriteMode, DCMIICRBase, T...> ;

  struct DCMIESCRBase {} ;

  struct ESCR : public RegisterBase<0x48020018, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ESCRPack  = Register<0x48020018, 32, ReadWriteMode, DCMIESCRBase, T...> ;

  struct DCMIESURBase {} ;

  struct ESUR : public RegisterBase<0x4802001C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ESURPack  = Register<0x4802001C, 32, ReadWriteMode, DCMIESURBase, T...> ;

  struct DCMICWSTRTBase {} ;

  struct CWSTRT : public RegisterBase<0x48020020, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CWSTRTPack  = Register<0x48020020, 32, ReadWriteMode, DCMICWSTRTBase, T...> ;

  struct DCMICWSIZEBase {} ;

  struct CWSIZE : public RegisterBase<0x48020024, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CWSIZEPack  = Register<0x48020024, 32, ReadWriteMode, DCMICWSIZEBase, T...> ;

  struct DCMIDRBase {} ;

  struct DR : public RegisterBase<0x48020028, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using DRPack  = Register<0x48020028, 32, ReadMode, DCMIDRBase, T...> ;
