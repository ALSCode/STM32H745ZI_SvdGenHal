...
struct TIM17
{
  ...
  struct DIER : public RegisterBase<0x4001480C, 32, ReadWriteMode>
  {
    ...
    using FieldValues = TIM17_DIER_COMDE_Values<TIM17::DIER, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct TIM17TIM17_AF1Base {} ;

  struct TIM17_AF1 : public RegisterBase<0x40014860, 32, ReadWriteMode>
  {
    using BKINE = TIM17_TIM17_AF1_BKINE_Values<TIM17::TIM17_AF1, 0, 1, ReadWriteMode, TIM17TIM17_AF1Base> ;
    using BKCMP1E = TIM17_TIM17_AF1_BKCMP1E_Values<TIM17::TIM17_AF1, 1, 1, ReadWriteMode, TIM17TIM17_AF1Base> ;
    using BKCMP2E = TIM17_TIM17_AF1_BKCMP2E_Values<TIM17::TIM17_AF1, 2, 1, ReadWriteMode, TIM17TIM17_AF1Base> ;
    using BKDFBK1E = TIM17_TIM17_AF1_BKDFBK1E_Values<TIM17::TIM17_AF1, 8, 1, ReadWriteMode, TIM17TIM17_AF1Base> ;
    using BKINP = TIM17_TIM17_AF1_BKINP_Values<TIM17::TIM17_AF1, 9, 1, ReadWriteMode, TIM17TIM17_AF1Base> ;
    using BKCMP1P = TIM17_TIM17_AF1_BKCMP1P_Values<TIM17::TIM17_AF1, 10, 1, ReadWriteMode, TIM17TIM17_AF1Base> ;
    using BKCMP2P = TIM17_TIM17_AF1_BKCMP2P_Values<TIM17::TIM17_AF1, 11, 1, ReadWriteMode, TIM17TIM17_AF1Base> ;
    using FieldValues = TIM17_TIM17_AF1_BKCMP2P_Values<TIM17::TIM17_AF1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using TIM17_AF1Pack  = Register<0x40014860, 32, ReadWriteMode, TIM17TIM17_AF1Base, T...> ;

  struct TIM17TIM17_TISELBase {} ;

  struct TIM17_TISEL : public RegisterBase<0x40014868, 32, ReadWriteMode>
  {
    using TI1SEL = TIM17_TIM17_TISEL_TI1SEL_Values<TIM17::TIM17_TISEL, 0, 4, ReadWriteMode, TIM17TIM17_TISELBase> ;
    using FieldValues = TIM17_TIM17_TISEL_TI1SEL_Values<TIM17::TIM17_TISEL, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using TIM17_TISELPack  = Register<0x40014868, 32, ReadWriteMode, TIM17TIM17_TISELBase, T...> ;
