...
struct SCB
{
  ...
  struct CCR : public RegisterBase<0xE000ED14, 32, ReadWriteMode>
  {
    ...
    using DC = SCB_CCR_DC_Values<SCB::CCR, 16, 1, ReadWriteMode, SCBCCRBase> ;
    using IC = SCB_CCR_IC_Values<SCB::CCR, 17, 1, ReadWriteMode, SCBCCRBase> ;
    using BP = SCB_CCR_BP_Values<SCB::CCR, 18, 1, ReadWriteMode, SCBCCRBase> ;
    using FieldValues = SCB_CCR_BP_Values<SCB::CCR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using MEMFAULTACT = SCB_SHCSR_MEMFAULTACT_Values<SCB::SHCSR, 0, 1, ReadWriteMode, SCBSHCSRBase> ;
    using BUSFAULTACT = SCB_SHCSR_BUSFAULTACT_Values<SCB::SHCSR, 1, 1, ReadWriteMode, SCBSHCSRBase> ;
    using USGFAULTACT = SCB_SHCSR_USGFAULTACT_Values<SCB::SHCSR, 3, 1, ReadWriteMode, SCBSHCSRBase> ;
    using SVCALLACT = SCB_SHCSR_SVCALLACT_Values<SCB::SHCSR, 7, 1, ReadWriteMode, SCBSHCSRBase> ;
    using MONITORACT = SCB_SHCSR_MONITORACT_Values<SCB::SHCSR, 8, 1, ReadWriteMode, SCBSHCSRBase> ;
    using PENDSVACT = SCB_SHCSR_PENDSVACT_Values<SCB::SHCSR, 10, 1, ReadWriteMode, SCBSHCSRBase> ;
    using SYSTICKACT = SCB_SHCSR_SYSTICKACT_Values<SCB::SHCSR, 11, 1, ReadWriteMode, SCBSHCSRBase> ;
    using USGFAULTPENDED = SCB_SHCSR_USGFAULTPENDED_Values<SCB::SHCSR, 12, 1, ReadWriteMode, SCBSHCSRBase> ;
    using MEMFAULTPENDED = SCB_SHCSR_MEMFAULTPENDED_Values<SCB::SHCSR, 13, 1, ReadWriteMode, SCBSHCSRBase> ;
    using BUSFAULTPENDED = SCB_SHCSR_BUSFAULTPENDED_Values<SCB::SHCSR, 14, 1, ReadWriteMode, SCBSHCSRBase> ;
    using SVCALLPENDED = SCB_SHCSR_SVCALLPENDED_Values<SCB::SHCSR, 15, 1, ReadWriteMode, SCBSHCSRBase> ;
    using MEMFAULTENA = SCB_SHCSR_MEMFAULTENA_Values<SCB::SHCSR, 16, 1, ReadWriteMode, SCBSHCSRBase> ;
    using BUSFAULTENA = SCB_SHCSR_BUSFAULTENA_Values<SCB::SHCSR, 17, 1, ReadWriteMode, SCBSHCSRBase> ;
    using USGFAULTENA = SCB_SHCSR_USGFAULTENA_Values<SCB::SHCSR, 18, 1, ReadWriteMode, SCBSHCSRBase> ;
    using FieldValues = SCB_SHCSR_USGFAULTENA_Values<SCB::SHCSR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SHCSRPack  = Register<0xE000ED24, 32, ReadWriteMode, SCBSHCSRBase, T...> ;

  struct SCBCFSR_UFSR_BFSR_MMFSRBase {} ;

  struct CFSR_UFSR_BFSR_MMFSR : public RegisterBase<0xE000ED28, 32, ReadWriteMode>
  {
    using IACCVIOL = SCB_CFSR_UFSR_BFSR_MMFSR_IACCVIOL_Values<SCB::CFSR_UFSR_BFSR_MMFSR, 0, 1, ReadWriteMode, SCBCFSR_UFSR_BFSR_MMFSRBase> ;
    using DACCVIOL = SCB_CFSR_UFSR_BFSR_MMFSR_DACCVIOL_Values<SCB::CFSR_UFSR_BFSR_MMFSR, 1, 1, ReadWriteMode, SCBCFSR_UFSR_BFSR_MMFSRBase> ;
  ...
  {
    using ADDRESS = SCB_MMFAR_ADDRESS_Values<SCB::MMFAR, 0, 32, ReadWriteMode, SCBMMFARBase> ;
    using FieldValues = SCB_MMFAR_ADDRESS_Values<SCB::MMFAR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using ADDRESS = SCB_BFAR_ADDRESS_Values<SCB::BFAR, 0, 32, ReadWriteMode, SCBBFARBase> ;
    using FieldValues = SCB_BFAR_ADDRESS_Values<SCB::BFAR, 0, 0, NoAccess, NoAccess> ;
  } ;
