...
struct LPTIM2
{
  ...
  struct ISR : public RegisterBase<0x58002400, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using ISRPack  = Register<0x58002400, 32, ReadMode, LPTIM2ISRBase, T...> ;

  struct LPTIM2ICRBase {} ;

  struct ICR : public RegisterBase<0x58002404, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using ICRPack  = Register<0x58002404, 32, WriteMode, LPTIM2ICRBase, T...> ;

  struct LPTIM2IERBase {} ;

  struct IER : public RegisterBase<0x58002408, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using IERPack  = Register<0x58002408, 32, ReadWriteMode, LPTIM2IERBase, T...> ;

  struct LPTIM2CFGRBase {} ;

  struct CFGR : public RegisterBase<0x5800240C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CFGRPack  = Register<0x5800240C, 32, ReadWriteMode, LPTIM2CFGRBase, T...> ;

  struct LPTIM2CRBase {} ;

  struct CR : public RegisterBase<0x58002410, 32, ReadWriteMode>
  {
    ...
    using FieldValues = LPTIM2_CR_RSTARE_Values<LPTIM2::CR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CRPack  = Register<0x58002410, 32, ReadWriteMode, LPTIM2CRBase, T...> ;

  struct LPTIM2CMPBase {} ;

  struct CMP : public RegisterBase<0x58002414, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CMPPack  = Register<0x58002414, 32, ReadWriteMode, LPTIM2CMPBase, T...> ;

  struct LPTIM2ARRBase {} ;

  struct ARR : public RegisterBase<0x58002418, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ARRPack  = Register<0x58002418, 32, ReadWriteMode, LPTIM2ARRBase, T...> ;

  struct LPTIM2CNTBase {} ;

  struct CNT : public RegisterBase<0x5800241C, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using CNTPack  = Register<0x5800241C, 32, ReadMode, LPTIM2CNTBase, T...> ;

  struct LPTIM2CFGR2Base {} ;

  struct CFGR2 : public RegisterBase<0x58002424, 32, ReadWriteMode>
  {
    using IN1SEL = LPTIM2_CFGR2_IN1SEL_Values<LPTIM2::CFGR2, 0, 2, ReadWriteMode, LPTIM2CFGR2Base> ;
    using IN2SEL = LPTIM2_CFGR2_IN2SEL_Values<LPTIM2::CFGR2, 4, 2, ReadWriteMode, LPTIM2CFGR2Base> ;
    using FieldValues = LPTIM2_CFGR2_IN2SEL_Values<LPTIM2::CFGR2, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CFGR2Pack  = Register<0x58002424, 32, ReadWriteMode, LPTIM2CFGR2Base, T...> ;
