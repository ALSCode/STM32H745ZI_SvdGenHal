...
struct UART5
{
  ...
  {
    using RXFFIE = UART5_CR1_RXFFIE_Values<UART5::CR1, 31, 1, ReadWriteMode, UART5CR1Base> ;
    using TXFEIE = UART5_CR1_TXFEIE_Values<UART5::CR1, 30, 1, ReadWriteMode, UART5CR1Base> ;
    using FIFOEN = UART5_CR1_FIFOEN_Values<UART5::CR1, 29, 1, ReadWriteMode, UART5CR1Base> ;
  ...
  struct CR2 : public RegisterBase<0x40005004, 32, ReadWriteMode>
  {
    ...
    using DIS_NSS = UART5_CR2_DIS_NSS_Values<UART5::CR2, 3, 1, ReadWriteMode, UART5CR2Base> ;
    using SLVEN = UART5_CR2_SLVEN_Values<UART5::CR2, 0, 1, ReadWriteMode, UART5CR2Base> ;
    using FieldValues = UART5_CR2_SLVEN_Values<UART5::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using TXFTCFG = UART5_CR3_TXFTCFG_Values<UART5::CR3, 29, 3, ReadWriteMode, UART5CR3Base> ;
    using RXFTIE = UART5_CR3_RXFTIE_Values<UART5::CR3, 28, 1, ReadWriteMode, UART5CR3Base> ;
    using RXFTCFG = UART5_CR3_RXFTCFG_Values<UART5::CR3, 25, 3, ReadWriteMode, UART5CR3Base> ;
    using TCBGTIE = UART5_CR3_TCBGTIE_Values<UART5::CR3, 24, 1, ReadWriteMode, UART5CR3Base> ;
    using TXFTIE = UART5_CR3_TXFTIE_Values<UART5::CR3, 23, 1, ReadWriteMode, UART5CR3Base> ;
  ...
  {
    using BRR_4_15 = UART5_BRR_BRR_4_15_Values<UART5::BRR, 4, 12, ReadWriteMode, UART5BRRBase> ;
    using BRR_0_3 = UART5_BRR_BRR_0_3_Values<UART5::BRR, 0, 4, ReadWriteMode, UART5BRRBase> ;
    using FieldValues = UART5_BRR_BRR_0_3_Values<UART5::BRR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using TXFT = UART5_ISR_TXFT_Values<UART5::ISR, 27, 1, ReadMode, UART5ISRBase> ;
    using RXFT = UART5_ISR_RXFT_Values<UART5::ISR, 26, 1, ReadMode, UART5ISRBase> ;
    using TCBGT = UART5_ISR_TCBGT_Values<UART5::ISR, 25, 1, ReadMode, UART5ISRBase> ;
    using RXFF = UART5_ISR_RXFF_Values<UART5::ISR, 24, 1, ReadMode, UART5ISRBase> ;
    using TXFE = UART5_ISR_TXFE_Values<UART5::ISR, 23, 1, ReadMode, UART5ISRBase> ;
    ...
    using UDR = UART5_ISR_UDR_Values<UART5::ISR, 13, 1, ReadMode, UART5ISRBase> ;
  ...
  struct ICR : public RegisterBase<0x40005020, 32, WriteMode>
  {
    ...
    using UDRCF = UART5_ICR_UDRCF_Values<UART5::ICR, 13, 1, WriteMode, UART5ICRBase> ;
    ...
    using TCBGTC = UART5_ICR_TCBGTC_Values<UART5::ICR, 7, 1, WriteMode, UART5ICRBase> ;
    using TCCF = UART5_ICR_TCCF_Values<UART5::ICR, 6, 1, WriteMode, UART5ICRBase> ;
    using TXFECF = UART5_ICR_TXFECF_Values<UART5::ICR, 5, 1, WriteMode, UART5ICRBase> ;
  ...
  struct UART5PRESCBase {} ;

  struct PRESC : public RegisterBase<0x4000502C, 32, ReadWriteMode>
  {
    using PRESCALER = UART5_PRESC_PRESCALER_Values<UART5::PRESC, 0, 4, ReadWriteMode, UART5PRESCBase> ;
    using FieldValues = UART5_PRESC_PRESCALER_Values<UART5::PRESC, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using PRESCPack  = Register<0x4000502C, 32, ReadWriteMode, UART5PRESCBase, T...> ;
