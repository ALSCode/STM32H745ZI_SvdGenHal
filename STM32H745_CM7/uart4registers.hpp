...
struct UART4
{
  ...
  {
    using RXFFIE = UART4_CR1_RXFFIE_Values<UART4::CR1, 31, 1, ReadWriteMode, UART4CR1Base> ;
    using TXFEIE = UART4_CR1_TXFEIE_Values<UART4::CR1, 30, 1, ReadWriteMode, UART4CR1Base> ;
    using FIFOEN = UART4_CR1_FIFOEN_Values<UART4::CR1, 29, 1, ReadWriteMode, UART4CR1Base> ;
  ...
  struct CR2 : public RegisterBase<0x40004C04, 32, ReadWriteMode>
  {
    ...
    using DIS_NSS = UART4_CR2_DIS_NSS_Values<UART4::CR2, 3, 1, ReadWriteMode, UART4CR2Base> ;
    using SLVEN = UART4_CR2_SLVEN_Values<UART4::CR2, 0, 1, ReadWriteMode, UART4CR2Base> ;
    using FieldValues = UART4_CR2_SLVEN_Values<UART4::CR2, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using TXFTCFG = UART4_CR3_TXFTCFG_Values<UART4::CR3, 29, 3, ReadWriteMode, UART4CR3Base> ;
    using RXFTIE = UART4_CR3_RXFTIE_Values<UART4::CR3, 28, 1, ReadWriteMode, UART4CR3Base> ;
    using RXFTCFG = UART4_CR3_RXFTCFG_Values<UART4::CR3, 25, 3, ReadWriteMode, UART4CR3Base> ;
    using TCBGTIE = UART4_CR3_TCBGTIE_Values<UART4::CR3, 24, 1, ReadWriteMode, UART4CR3Base> ;
    using TXFTIE = UART4_CR3_TXFTIE_Values<UART4::CR3, 23, 1, ReadWriteMode, UART4CR3Base> ;
  ...
  {
    using BRR_4_15 = UART4_BRR_BRR_4_15_Values<UART4::BRR, 4, 12, ReadWriteMode, UART4BRRBase> ;
    using BRR_0_3 = UART4_BRR_BRR_0_3_Values<UART4::BRR, 0, 4, ReadWriteMode, UART4BRRBase> ;
    using FieldValues = UART4_BRR_BRR_0_3_Values<UART4::BRR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using TXFT = UART4_ISR_TXFT_Values<UART4::ISR, 27, 1, ReadMode, UART4ISRBase> ;
    using RXFT = UART4_ISR_RXFT_Values<UART4::ISR, 26, 1, ReadMode, UART4ISRBase> ;
    using TCBGT = UART4_ISR_TCBGT_Values<UART4::ISR, 25, 1, ReadMode, UART4ISRBase> ;
    using RXFF = UART4_ISR_RXFF_Values<UART4::ISR, 24, 1, ReadMode, UART4ISRBase> ;
    using TXFE = UART4_ISR_TXFE_Values<UART4::ISR, 23, 1, ReadMode, UART4ISRBase> ;
    ...
    using UDR = UART4_ISR_UDR_Values<UART4::ISR, 13, 1, ReadMode, UART4ISRBase> ;
  ...
  struct ICR : public RegisterBase<0x40004C20, 32, WriteMode>
  {
    ...
    using UDRCF = UART4_ICR_UDRCF_Values<UART4::ICR, 13, 1, WriteMode, UART4ICRBase> ;
    ...
    using TCBGTC = UART4_ICR_TCBGTC_Values<UART4::ICR, 7, 1, WriteMode, UART4ICRBase> ;
    using TCCF = UART4_ICR_TCCF_Values<UART4::ICR, 6, 1, WriteMode, UART4ICRBase> ;
    using TXFECF = UART4_ICR_TXFECF_Values<UART4::ICR, 5, 1, WriteMode, UART4ICRBase> ;
  ...
  struct UART4PRESCBase {} ;

  struct PRESC : public RegisterBase<0x40004C2C, 32, ReadWriteMode>
  {
    using PRESCALER = UART4_PRESC_PRESCALER_Values<UART4::PRESC, 0, 4, ReadWriteMode, UART4PRESCBase> ;
    using FieldValues = UART4_PRESC_PRESCALER_Values<UART4::PRESC, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using PRESCPack  = Register<0x40004C2C, 32, ReadWriteMode, UART4PRESCBase, T...> ;
